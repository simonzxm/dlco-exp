module cli (
  ...
  wire [ 4:0] vram_row = offset ? ((y_sum >= 6'd30) ? (y_sum - 6'd30) : y_sum[4:0]) : v_addr[9:4];
  wire [11:0] vram_addr = (vram_row * 80) + h_addr[9:3];
  wire [ 7:0] char_code = vram_valid[vram_addr] ? vram[vram_addr] : 8'h20;
